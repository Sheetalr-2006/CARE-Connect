    ...
    <div className="min-h-screen bg-white text-[#1A1D20] font-sans selection:bg-primary selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/" className="flex items-center gap-2.5 group">
              ...
              <span className="font-bold text-lg sm:text-xl tracking-tight text-slate-900 font-serif">
      ...
      <footer className="border-t border-[#1E2229] bg-[#1E2229] text-white py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-primary flex items-center justify-center text-white font-bold">
              <Heart size={18} className="fill-white" />
            </div>
            <div>
              <p className="font-bold text-base text-white font-serif">CareConnect Elderly Network</p>
              <p className="text-xs text-white/60">© 2026 CareConnect Platform. All rights reserved.</p>
            </div>
          </div>
